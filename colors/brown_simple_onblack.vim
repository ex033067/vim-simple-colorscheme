...
hi Normal             guifg=#D59447 guibg=gray9
...
hi customInvertedDark guifg=black guibg=#8B4513
hi customInvertedLight guifg=LightGray guibg=#8B4513
hi customStatusLine   guifg=LightGray guibg=#8B4513 gui=NONE    cterm=NONE
